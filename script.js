...
document.addEventListener('DOMContentLoaded', function(event) {
    ...
    var script = document.getElementById('kasipay_script');
    var script_parent = script.parentNode;
    var button = document.createElement('a');
    button.classList.add('ks_button', 'pay');
    button.textContent = 'Pay with Kasipay';
    ...
    //button insert
    script_parent.insertBefore(button, script);
